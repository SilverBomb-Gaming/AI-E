...
- the conversation gate routes top-level chat state into `GREETING`, `THANKS`, `SESSION_CLOSE`, `CAPABILITY_HELP`, `CONTINUE_PREVIOUS`, `TROUBLESHOOT_PREVIOUS`, `FRUSTRATION_OR_CONFUSION`, `GAME_DEV_TASK`, `CODEX_HANDOFF_REQUEST`, `CLARIFICATION_NEEDED`, or `BLOCKED_OR_UNSAFE`
