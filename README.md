...
- remaining unreal capabilities stay explicitly out of scope: no unbounded looping, no recursion, no broad file-target expansion, no automatic rollback execution proof for this loop, and no direct chat-triggered Unity mutation path
