...
from .runtime_state import RuntimeState, integrity_issue_lines, loop_visibility_lines, selection_visibility_lines
...
class ConversationRouter:
    ...
    def _shared_status_lines(self, snapshot, heartbeat_age) -> List[str]:
        ...
        lines.extend(loop_visibility_lines(snapshot))
        lines.extend(selection_visibility_lines(snapshot))
        lines.extend(integrity_issue_lines(snapshot))
