          ...
          {!session ? (
            ...
            <div className="mt-5 space-y-5">
              ...
              <div className="rounded-[1.2rem] border border-ink/10 bg-white/70 p-4 text-sm leading-7 text-ink/80">
                ...
                <p><strong>Approval state:</strong> {session.workflowContinuity.coding.approvalStateSummary || "No approval state recorded yet."}</p>
                <p><strong>Repo action summary:</strong> {session.workflowContinuity.coding.repoActionSummary || "No repo actions derived yet."}</p>
                <p><strong>Readiness guardrails:</strong> {session.workflowContinuity.coding.integritySummary || "No readiness guardrails are currently active."}</p>
