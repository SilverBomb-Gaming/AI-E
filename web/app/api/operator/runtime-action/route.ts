...
function normalizeAction(value: unknown): OperatorControlAction | null {
  ...
  if (
    ...
    && candidate.type !== "pause_governed_lane"
    && candidate.type !== "resume_governed_lane"
    && candidate.type !== "reprioritize_governed_lane"
    && candidate.type !== "merge_governed_lanes"
    && candidate.type !== "terminate_governed_lane"
...
export async function POST(request: Request) {
  ...
  try {
    ...
    if (runtimeStateStore
      ...
      && actionResult.runtime_intent !== "pause_governed_lane"
      && actionResult.runtime_intent !== "resume_governed_lane"
      && actionResult.runtime_intent !== "reprioritize_governed_lane"
      && actionResult.runtime_intent !== "merge_governed_lanes"
      && actionResult.runtime_intent !== "terminate_governed_lane"
