  ...
  const state = buildOperatorDashboardState({
    ...
    review_packages: [
      ...
      createAutonomousReviewPackage({
        ...
        risks: ["DRY RUN ONLY", "NOT EXECUTED", "Demo preview only. No Unity scene mutation path enabled."],
        recommended_decision: "approve",
    ...
    delivery_packages: [
      ...
      createAutonomousDeliveryPackage({
        ...
        risk_summary: "Dry-run Unity mutation preview only. No mutation path enabled.",
