...
import {
  buildDeterministicEventBeat,
} from "./staging/eventBeatModel";
import {
  computeGovernedFocusFlowFrame,
} from "./focusFlow/governedFocusFlow";
import { summarizeCinematicFocusFlowDiagnostics } from "./focusFlow/focusFlowDiagnostics";
import {
  computeGovernedTensionCurveFrame,
} from "./tension/governedTensionCurves";
import {
  computeGovernedMomentumFlowFrame,
} from "./momentum/governedMomentumFlow";
import {
  computeGovernedTransitionBlendFrame,
} from "./transitionBlend/governedTransitionBlending";
import {
  computeGovernedSceneCohesionFrame,
} from "./sceneCohesion/governedSceneCohesion";
import { summarizeCinematicStagingDiagnostics } from "./staging/stagingDiagnostics";
import { summarizeCinematicMomentumDiagnostics } from "./momentum/momentumDiagnostics";
import { summarizeCinematicTransitionBlendDiagnostics } from "./transitionBlend/transitionBlendDiagnostics";
import { summarizeCinematicSceneCohesionDiagnostics } from "./sceneCohesion/sceneCohesionDiagnostics";
import { summarizeCinematicTensionDiagnostics } from "./tension/tensionDiagnostics";
import {
  computeCinematicStagingFrame,
} from "./staging/stagingPrioritySolver";
import type { CinematicBeatType, CinematicStagingSnapshot, StagingFocusSubject } from "./staging/cinematicStagingState";
import type { CinematicFocusFlowSnapshot, FocusSubject } from "./focusFlow/cinematicFocusFlowState";
import type { CinematicMomentumSnapshot, MomentumPhase } from "./momentum/cinematicMomentumState";
import type { BlendPhase, CinematicTransitionBlendSnapshot } from "./transitionBlend/cinematicTransitionBlendState";
import type { CinematicSceneCohesionSnapshot, SceneIdentityType } from "./sceneCohesion/cinematicSceneCohesionState";
import type { CinematicTensionSnapshot, TensionPhase } from "./tension/cinematicTensionState";
...
export type CinematicSandboxSimulationRecord = {
  ...
  continuity_sequence_containment?: CinematicContinuitySequenceContainmentRegistryEntry[];
  governed_micro_sequence_sandbox?: CinematicGovernedMicroSequenceSandbox;
  continuity_preview_sequencing?: CinematicContinuityPreviewSequencingPath;
...
export type CinematicAllowedTemporalScope =
  | "micro-sequence-only"
  | "bounded-preview-window"
  | "continuity-anchor-linked";

export type CinematicContinuityStrength = "light" | "moderate" | "strong";

export type CinematicContinuitySequenceContainmentRegistryEntry = {
  sequence_id: string;
  maximum_frame_count: number;
  ...
  frame_consistency_requirements: string[];
  governance_constraints: string[];
  output_constraints: string[];
  forbidden_sequence_behaviors: string[];
  containment_expiration: string;
};

export type CinematicGovernedMicroSequenceSandbox = {
  sandbox_id: string;
  recorded_at: string;
...
export type CinematicGovernedPreviewQualityIndicatorId =
  ...
  | "focus-camera-compatibility"
  | "tension-continuity"
  | "tension-readability"
  | "reveal-peak-preservation"
  | "decay-stability"
  | "tension-camera-compatibility"
  | "momentum-continuity"
  | "momentum-readability"
  | "reveal-propagation"
  | "reaction-carryover"
  | "decay-inertia"
  | "momentum-camera-compatibility"
  | "transition-smoothness"
  | "visual-continuity"
  | "reveal-transition-preservation"
  | "response-to-aftermath"
  | "settle-blend-stability"
  | "blend-camera-compatibility"
  | "scene-visual-language"
  | "scene-phrase-continuity"
  | "scene-cohesion"
  | "environment-identity"
  | "formation-identity"
  | "final-composition"
  | "cohesion-camera-compatibility";
...
export type CinematicGovernedPreviewFrameDiagnostic = {
  ...
  previous_focus_subject?: FocusSubject;
  active_tension_phase?: TensionPhase;
  active_momentum_phase?: MomentumPhase;
  active_blend_phase?: BlendPhase;
  active_scene_identity?: SceneIdentityType;
  anchor_x: number;
  anchor_y: number;
  beacon_x: number;
  beacon_y: number;
  platform_y: number;
  from_beat?: CinematicBeatType;
  to_beat?: CinematicBeatType;
  beat_phase?: number;
  focus_subject?: StagingFocusSubject;
  focus_transition_phase?: number;
  focus_priority_score?: number;
  focus_continuity_score?: number;
  subject_readability_score?: number;
  reveal_focus_preservation_score?: number;
  drone_response_focus_score?: number;
  aftermath_focus_balance_score?: number;
  focus_camera_compatibility_score?: number;
  tension_intensity?: number;
  escalation_rate?: number;
  release_rate?: number;
  tension_continuity_score?: number;
  tension_readability_score?: number;
  reveal_peak_preservation_score?: number;
  decay_stability_score?: number;
  tension_focus_compatibility_score?: number;
  tension_camera_compatibility_score?: number;
  momentum_intensity?: number;
  propagation_rate?: number;
  stabilization_rate?: number;
  momentum_continuity_score?: number;
  momentum_readability_score?: number;
  reveal_propagation_score?: number;
  reaction_carryover_score?: number;
  decay_inertia_score?: number;
  momentum_camera_compatibility_score?: number;
  blend_progress?: number;
  blend_weight?: number;
  transition_smoothness_score?: number;
  visual_continuity_score?: number;
  reveal_transition_preservation_score?: number;
  response_to_aftermath_score?: number;
  settle_blend_stability_score?: number;
  blend_camera_compatibility_score?: number;
  cohesion_weight?: number;
  visual_language_score?: number;
  phrase_continuity_score?: number;
  scene_cohesion_score?: number;
  environment_identity_score?: number;
  formation_identity_score?: number;
  final_composition_score?: number;
  cohesion_camera_compatibility_score?: number;
  staging_intensity?: number;
  entity_count?: number;
  entity_ids?: string[];
  joint_count?: number;
  ...
  beat_readability_score?: number;
  focus_persistence_score?: number;
  event_focus_alignment_score?: number;
  staging_camera_compatibility_score?: number;
  rejected_staging_transition_count?: number;
  rejected_focus_transition_count?: number;
  rejected_tension_transition_count?: number;
  rejected_momentum_transition_count?: number;
  rejected_blend_transition_count?: number;
  rejected_cohesion_transition_count?: number;
  ...
  rollback_restored_staging?: boolean;
  rollback_restored_focus?: boolean;
  rollback_restored_tension?: boolean;
  rollback_restored_momentum?: boolean;
  rollback_restored_blend?: boolean;
  rollback_restored_cohesion?: boolean;
  ...
  cinematic_staging_overlay?: string;
  cinematic_focus_flow_overlay?: string;
  cinematic_tension_curve_overlay?: string;
  cinematic_momentum_flow_overlay?: string;
  cinematic_transition_blend_overlay?: string;
  cinematic_scene_cohesion_overlay?: string;
...
export type CinematicGovernedPreviewDiagnostics = {
  ...
  cinematic_staging_summary?: string;
  cinematic_focus_flow_summary?: string;
  cinematic_tension_curve_summary?: string;
  ...
  rollback_restored_cohesion?: boolean;
  rejected_cohesion_transition_count?: number;
  reaction_continuity_score?: number;
  event_causality_score?: number;
  camera_event_framing_score?: number;
...
export type CinematicContinuityPreviewSequencingStage =
  | "continuity_sequence_request"
  | "continuity_anchor_prepare"
  | "frame_sequence_stage"
  | "continuity_validation_stage"
  | "bounded_sequence_write"
  | "rollback_ready"
  | "sequence_archived";

export type CinematicContinuityPreviewSequencingStageState = {
  stage: CinematicContinuityPreviewSequencingStage;
  order: number;
  status: "ready" | "completed" | "rollback_ready" | "archived" | "blocked";
  detail: string;
  blockers: string[];
...
export type CinematicContinuityPreviewSequencingPath = {
  path_id: string;
  recorded_at: string;
  sequence_id: string | null;
  output_file_paths: string[];
  stages: CinematicContinuityPreviewSequencingStageState[];
  next_stage: CinematicContinuityPreviewSequencingStage | null;
};

export type CinematicFrameToFrameContinuityValidationCheckName =
  | "continuity-anchor-integrity"
  | "sequence-length-restrictions"
  | "output-containment-restrictions"
  | "rollback-availability"
  | "runtime-integrity-sufficiency"
  | "forbidden-state-enforcement"
  | "continuity-drift-thresholds"
  | "temporal-scope-restrictions";

export type CinematicFrameToFrameContinuityValidationCheck = {
  check: CinematicFrameToFrameContinuityValidationCheckName;
  passed: boolean;
  detail: string;
  blockers: string[];
};

export type CinematicFrameToFrameContinuityValidation = {
  validation_id: string;
  recorded_at: string;
  valid: boolean;
  checks: CinematicFrameToFrameContinuityValidationCheck[];
  blocked_transitions: string[];
  next_unlock_condition: string;
};

export type CinematicSequenceRollbackRecoveryActionKind =
  | "sequence-rollback-cleanup"
  | "bounded-sequence-deletion"
  | "continuity-reset-recovery"
  | "rollback-authority-enforcement"
  | "sequence-attempt-archival"
  | "containment-violation-recovery";

export type CinematicSequenceRollbackRecoveryAction = {
  action: CinematicSequenceRollbackRecoveryActionKind;
  triggered: boolean;
  detail: string;
  affected_output_targets: string[];
};

export type CinematicSequenceRollbackRecoveryLayer = {
  recovery_id: string;
  recorded_at: string;
  actions: CinematicSequenceRollbackRecoveryAction[];
};

export type CinematicFutureCinematicContinuityId =
  | "governed-teaser-preview-mode"
  | "continuity-safe-trailer-sequencing"
  | "governed-dialogue-scene-previews"
  | "continuity-preserving-cinematic-mode"
  | "governed-episodic-sequencing"
  | "governed-feature-length-orchestration";

export type CinematicFutureCinematicContinuityEntry = {
  continuity_id: CinematicFutureCinematicContinuityId;
  unlocked: false;
  prerequisites: string[];
  still_forbidden_operations: string[];
};

export type CinematicFutureCinematicContinuityScaffolding = {
  scaffold_id: string;
  recorded_at: string;
  entries: CinematicFutureCinematicContinuityEntry[];
...
export type CinematicProductionMemoryRecord = {
  ...
  continuity_sequence_containment_history: CinematicContinuitySequenceContainmentRegistryEntry[][];
  governed_micro_sequence_sandbox_history: CinematicGovernedMicroSequenceSandbox[];
  continuity_preview_sequencing_history: CinematicContinuityPreviewSequencingPath[];
...
const DEFAULT_PRODUCTION_MEMORY_RECORD: CinematicProductionMemoryRecord = {
  ...
  continuity_sequence_containment_history: [],
  governed_micro_sequence_sandbox_history: [],
  continuity_preview_sequencing_history: [],
...
function hydrateProductionMemoryRecord(record: Partial<CinematicProductionMemoryRecord> | undefined): CinematicProductionMemoryRecord {
  ...
  return {
    ...
    continuity_sequence_containment_history: nextRecord.continuity_sequence_containment_history ?? defaults.continuity_sequence_containment_history,
    governed_micro_sequence_sandbox_history: nextRecord.governed_micro_sequence_sandbox_history ?? defaults.governed_micro_sequence_sandbox_history,
    continuity_preview_sequencing_history: nextRecord.continuity_preview_sequencing_history ?? defaults.continuity_preview_sequencing_history,
...
function buildContinuitySequenceContainmentRegistry(input: {
  readiness: CinematicLocalInferenceReadinessReport;
  authorizationRegistry: CinematicRealOutputAuthorizationRegistryEntry[];
}): CinematicContinuitySequenceContainmentRegistryEntry[] {
  const continuityStrength: CinematicContinuityStrength = (input.readiness.milestone_progress.find((entry) => entry.milestone === "continuity-preserving-local-generation")?.percentage ?? 0) >= 80
    ? "strong"
    : "moderate";
  return [
    {
      sequence_id: "sequence-governed-micro-preview-001",
      maximum_frame_count: 3,
      allowed_temporal_scope: "micro-sequence-only",
      continuity_anchor_policy: "frame-001 remains the sequence anchor for all continuity comparisons",
      continuity_strength: continuityStrength,
      rollback_window: 3,
      escalation_threshold: 1,
      frame_consistency_requirements: [
        "all frames must preserve the same continuity anchor signature",
        "drift may not exceed the bounded continuity threshold",
      ],
      governance_constraints: [
        "manual sequence approval required",
        "bounded retry limit: 1",
        `authorized_targets=${input.authorizationRegistry.flatMap((entry) => entry.allowed_output_targets).join(",")}`,
      ],
      output_constraints: [
        "low_resolution_only",
        "sandboxed_sequence_directory_only",
        "maximum_5_frames_forbidden_boundary_enforced",
      ],
      forbidden_sequence_behaviors: [
        "long_clip_generation",
        "autonomous_continuation",
        "unbounded_temporal_synthesis",
        "unsandboxed_sequence_write",
      ],
      containment_expiration: "expires_after_single_reviewed_micro_sequence_execution",
    },
  ];
}

function buildFrameToFrameContinuityValidation(input: {
  sequenceContainment: CinematicContinuitySequenceContainmentRegistryEntry[];
  governedSandbox: CinematicGovernedLowResolutionSandbox;
  outputContainmentValidation: CinematicOutputContainmentValidation;
  bootstrap: CinematicDryRuntimeBootstrapValidation;
  forbiddenExecutionStates: CinematicForbiddenExecutionStateEnforcement;
}): CinematicFrameToFrameContinuityValidation {
  ...
  const checks: CinematicFrameToFrameContinuityValidationCheck[] = [
    {
      ...
      detail: "A continuity anchor must exist before multi-frame preview sequencing is allowed.",
      blockers: Boolean(containment?.continuity_anchor_policy) ? [] : ["Continuity anchor is missing."],
    },
    {
      check: "sequence-length-restrictions",
      passed: frameCount >= 2 && frameCount <= 5,
      detail: "Micro-sequence previews must stay within the 2 to 5 frame window.",
      blockers: frameCount >= 2 && frameCount <= 5 ? [] : ["Sequence length is outside the bounded 2-5 frame window."],
    },
    {
    ...
    {
      check: "rollback-availability",
      passed: containment !== null && containment.rollback_window >= frameCount,
      detail: "Rollback window must cover the full bounded micro-sequence.",
      blockers: containment !== null && containment.rollback_window >= frameCount ? [] : ["Rollback window does not cover the entire sequence."],
    },
    {
      check: "runtime-integrity-sufficiency",
    ...
    },
    {
      check: "forbidden-state-enforcement",
      passed: input.forbiddenExecutionStates.states.every((entry) => entry.blocked),
      detail: "Forbidden-state enforcement must keep unrestricted temporal behaviors blocked.",
      blockers: input.forbiddenExecutionStates.states.every((entry) => entry.blocked) ? [] : ["A forbidden temporal state is not blocked."],
    },
    {
      check: "continuity-drift-thresholds",
      passed: driftThreshold <= 1,
      detail: "Continuity drift thresholds must remain extremely tight for the first preview sequence.",
      blockers: driftThreshold <= 1 ? [] : ["Continuity drift threshold exceeds the bounded micro-sequence limit."],
    },
    {
      check: "temporal-scope-restrictions",
      passed: containment?.allowed_temporal_scope === "micro-sequence-only",
      detail: "Temporal scope must remain restricted to micro-sequence previews only.",
      blockers: containment?.allowed_temporal_scope === "micro-sequence-only" ? [] : ["Temporal scope exceeds the bounded micro-sequence policy."],
    },
  ];
  return {
    validation_id: `frame-to-frame-continuity-validation-${Date.now()}`,
    recorded_at: new Date().toISOString(),
    valid: checks.every((entry) => entry.passed),
    checks,
    blocked_transitions: checks.filter((entry) => !entry.passed).map((entry) => entry.check),
    next_unlock_condition: checks.find((entry) => !entry.passed)?.detail ?? "Micro-sequence continuity preview is validated within bounded temporal scope.",
  };
}

function buildDeterministicContinuityPreviewFrame(input: {
  frameIndex: number;
  width: number;
  height: number;
}): string {
  const rows = ["P3", `# AI-E governed micro-sequence frame ${input.frameIndex + 1}`, `${input.width} ${input.height}`, "255"];
  for (let y = 0; y < input.height; y += 1) {
    const pixels: string[] = [];
    for (let x = 0; x < input.width; x += 1) {
      const red = (x * 17 + input.frameIndex * 9) % 256;
      const green = (y * 29 + input.frameIndex * 7) % 256;
      const blue = ((x + y) * 11 + input.frameIndex * 5) % 256;
      pixels.push(`${red} ${green} ${blue}`);
    }
    rows.push(pixels.join(" "));
  }
...
type GovernedRenderedFrame = {
  ...
  stagingSnapshot: CinematicStagingSnapshot;
  focusFlowSnapshot: CinematicFocusFlowSnapshot;
  tensionSnapshot: CinematicTensionSnapshot;
  momentumSnapshot: CinematicMomentumSnapshot;
  transitionBlendSnapshot: CinematicTransitionBlendSnapshot;
  sceneCohesionSnapshot: CinematicSceneCohesionSnapshot;
};
...
function summarizeGovernedPreviewDiagnostics(input: {
  ...
  const articulatedSummary = summarizeArticulatedEntityDiagnostics(articulatedDiagnostics.map((entry) => ({
    ...
    poseStabilityScore: entry.pose_stability_score ?? 0,
    silhouetteReadabilityScore: entry.silhouette_readability_score ?? 0,
    entitySpatialPersistenceScore: entry.entity_spatial_persistence_score ?? 0,
    entityCameraFramingCompatibilityScore: entry.entity_camera_framing_compatibility_score ?? 0,
  ...
  const stagingDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_beat_type && typeof entry.staging_intensity === "number");
  const stagingSummary = summarizeCinematicStagingDiagnostics(stagingDiagnostics.map((entry) => ({
    activeBeatType: entry.active_beat_type ?? "BASELINE",
    beatPhase: entry.beat_phase ?? 0,
    focusSubject: entry.focus_subject ?? "CUBE",
    stagingIntensity: entry.staging_intensity ?? 0,
    emphasisScore: entry.emphasis_score ?? 0,
    beatReadabilityScore: entry.beat_readability_score ?? 0,
    focusPersistenceScore: entry.focus_persistence_score ?? 0,
    eventFocusAlignmentScore: entry.event_focus_alignment_score ?? 0,
    stagingCameraCompatibilityScore: entry.staging_camera_compatibility_score ?? 0,
    rollbackRestoredStaging: entry.rollback_restored_staging ?? false,
    rejectedStagingTransitionCount: entry.rejected_staging_transition_count ?? 0,
    overlay: entry.cinematic_staging_overlay ?? "",
  })));
  const reactionContinuityScore = stagingDiagnostics.length > 0
    ? averagePreviewScore(input.frameDiagnostics.map((entry) => Math.round(((entry.choreography_continuity_score ?? 0) + entry.interaction_persistence_score) / 2)))
    : averagePreviewScore(input.frameDiagnostics.map((entry) => entry.interaction_persistence_score));
  const eventCausalityScore = stagingDiagnostics.length > 0
    ? averagePreviewScore(input.frameDiagnostics.map((entry) => Math.round(((entry.emphasis_score ?? 0) + (entry.event_focus_alignment_score ?? 0) + entry.environmental_response_score) / 3)))
    : environmentalResponseScore;
  const cameraEventFramingScore = stagingDiagnostics.length > 0
    ? averagePreviewScore(input.frameDiagnostics.map((entry) => Math.round((((entry.staging_camera_compatibility_score ?? 0) + (entry.framing_score ?? entry.readability_score) + (entry.camera_continuity_score ?? entry.camera_stability_score)) / 3))))
    : averagePreviewScore([cameraContinuityScore, framingPersistenceScore]);
  const focusFlowDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_focus_subject && entry.previous_focus_subject && typeof entry.focus_continuity_score === "number");
  const focusFlowSummary = summarizeCinematicFocusFlowDiagnostics(focusFlowDiagnostics.map((entry) => ({
    beatType: entry.active_beat_type ?? "BASELINE",
    activeFocusSubject: entry.active_focus_subject ?? "FULL_SCENE",
    previousFocusSubject: entry.previous_focus_subject ?? "FULL_SCENE",
    focusTransitionPhase: entry.focus_transition_phase ?? 0,
    focusPriorityScore: entry.focus_priority_score ?? 0,
    focusContinuityScore: entry.focus_continuity_score ?? 0,
    subjectReadabilityScore: entry.subject_readability_score ?? 0,
    revealFocusPreservationScore: entry.reveal_focus_preservation_score ?? 0,
    droneResponseFocusScore: entry.drone_response_focus_score ?? 0,
    aftermathFocusBalanceScore: entry.aftermath_focus_balance_score ?? 0,
    focusCameraCompatibilityScore: entry.focus_camera_compatibility_score ?? 0,
    rollbackRestoredFocus: entry.rollback_restored_focus ?? false,
    rejectedFocusTransitionCount: entry.rejected_focus_transition_count ?? 0,
    overlay: entry.cinematic_focus_flow_overlay ?? "",
  })));
  const tensionDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_tension_phase && typeof entry.tension_intensity === "number");
  const tensionSummary = summarizeCinematicTensionDiagnostics(tensionDiagnostics.map((entry) => ({
    beatType: entry.active_beat_type ?? "BASELINE",
    activeTensionPhase: entry.active_tension_phase ?? "LOW_BUILD",
    tensionIntensity: entry.tension_intensity ?? 0,
    escalationRate: entry.escalation_rate ?? 0,
    releaseRate: entry.release_rate ?? 0,
    tensionContinuityScore: entry.tension_continuity_score ?? 0,
    tensionReadabilityScore: entry.tension_readability_score ?? 0,
    revealPeakPreservationScore: entry.reveal_peak_preservation_score ?? 0,
    decayStabilityScore: entry.decay_stability_score ?? 0,
    tensionFocusCompatibilityScore: entry.tension_focus_compatibility_score ?? 0,
    tensionCameraCompatibilityScore: entry.tension_camera_compatibility_score ?? 0,
    rollbackRestoredTension: entry.rollback_restored_tension ?? false,
    rejectedTensionTransitionCount: entry.rejected_tension_transition_count ?? 0,
    overlay: entry.cinematic_tension_curve_overlay ?? "",
  })));
  const momentumDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_momentum_phase && typeof entry.momentum_intensity === "number");
  const momentumSummary = summarizeCinematicMomentumDiagnostics(momentumDiagnostics.map((entry) => ({
    beatType: entry.active_beat_type ?? "BASELINE",
    activeMomentumPhase: entry.active_momentum_phase ?? "MOMENTUM_BUILD",
    momentumIntensity: entry.momentum_intensity ?? 0,
    propagationRate: entry.propagation_rate ?? 0,
    stabilizationRate: entry.stabilization_rate ?? 0,
    momentumContinuityScore: entry.momentum_continuity_score ?? 0,
    momentumReadabilityScore: entry.momentum_readability_score ?? 0,
    revealPropagationScore: entry.reveal_propagation_score ?? 0,
    reactionCarryoverScore: entry.reaction_carryover_score ?? 0,
    decayInertiaScore: entry.decay_inertia_score ?? 0,
    momentumCameraCompatibilityScore: entry.momentum_camera_compatibility_score ?? 0,
    rollbackRestoredMomentum: entry.rollback_restored_momentum ?? false,
    rejectedMomentumTransitionCount: entry.rejected_momentum_transition_count ?? 0,
    overlay: entry.cinematic_momentum_flow_overlay ?? "",
  })));
  const transitionBlendDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_blend_phase && typeof entry.blend_weight === "number");
  const transitionBlendSummary = summarizeCinematicTransitionBlendDiagnostics(transitionBlendDiagnostics.map((entry) => ({
    activeBlendPhase: entry.active_blend_phase ?? "SETTLED",
    fromBeat: entry.from_beat ?? "BASELINE",
    toBeat: entry.to_beat ?? "BASELINE",
    blendProgress: entry.blend_progress ?? 0,
    blendWeight: entry.blend_weight ?? 0,
    transitionSmoothnessScore: entry.transition_smoothness_score ?? 0,
    visualContinuityScore: entry.visual_continuity_score ?? 0,
    revealTransitionPreservationScore: entry.reveal_transition_preservation_score ?? 0,
    responseToAftermathScore: entry.response_to_aftermath_score ?? 0,
    settleBlendStabilityScore: entry.settle_blend_stability_score ?? 0,
    blendCameraCompatibilityScore: entry.blend_camera_compatibility_score ?? 0,
    rollbackRestoredBlend: entry.rollback_restored_blend ?? false,
    rejectedBlendTransitionCount: entry.rejected_blend_transition_count ?? 0,
    overlay: entry.cinematic_transition_blend_overlay ?? "",
  })));
  const sceneCohesionDiagnostics = input.frameDiagnostics.filter((entry) => entry.active_scene_identity && typeof entry.cohesion_weight === "number");
  const sceneCohesionSummary = summarizeCinematicSceneCohesionDiagnostics(sceneCohesionDiagnostics.map((entry) => ({
    activeSceneIdentity: entry.active_scene_identity ?? "SCI_FI_BEACON_CHAMBER",
    beatType: entry.active_beat_type ?? "BASELINE",
    cohesionWeight: entry.cohesion_weight ?? 0,
    visualLanguageScore: entry.visual_language_score ?? 0,
    phraseContinuityScore: entry.phrase_continuity_score ?? 0,
    sceneCohesionScore: entry.scene_cohesion_score ?? 0,
    environmentIdentityScore: entry.environment_identity_score ?? 0,
    formationIdentityScore: entry.formation_identity_score ?? 0,
    finalCompositionScore: entry.final_composition_score ?? 0,
    cohesionCameraCompatibilityScore: entry.cohesion_camera_compatibility_score ?? 0,
    rollbackRestoredCohesion: entry.rollback_restored_cohesion ?? false,
    rejectedCohesionTransitionCount: entry.rejected_cohesion_transition_count ?? 0,
    overlay: entry.cinematic_scene_cohesion_overlay ?? "",
  })));
  const continuityQualityIndicators = [
    ...
    buildGovernedPreviewIndicator({
      id: "staging-emphasis",
      label: "Staging Emphasis",
      score: stagingSummary.emphasisScore,
      summary: `Cinematic beat emphasis remains bounded at ${stagingSummary.emphasisScore}/100 while the reveal stays deterministic and review-safe.`,
    }),
    buildGovernedPreviewIndicator({
      id: "beat-readability",
      label: "Beat Readability",
      score: stagingSummary.beatReadabilityScore,
      summary: `The active beat reads at ${stagingSummary.beatReadabilityScore}/100 without collapsing beacon, drone group, and chamber composition into one noisy event cluster.`,
    }),
    buildGovernedPreviewIndicator({
      id: "focus-persistence",
      label: "Focus Persistence",
      score: stagingSummary.focusPersistenceScore,
      summary: `Bounded focus targeting holds ${stagingSummary.focusPersistenceScore}/100 persistence across the governed preview window.`,
    }),
    buildGovernedPreviewIndicator({
      id: "event-focus-alignment",
      label: "Event Focus Alignment",
      score: stagingSummary.eventFocusAlignmentScore,
      summary: `Beacon reveal and group emphasis stay aligned at ${stagingSummary.eventFocusAlignmentScore}/100 without direct camera control.`,
    }),
    buildGovernedPreviewIndicator({
      id: "staging-camera-compatibility",
      label: "Staging Camera Compatibility",
      score: stagingSummary.stagingCameraCompatibilityScore,
      summary: `Staging hints and authoritative camera framing stay compatible at ${stagingSummary.stagingCameraCompatibilityScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "focus-continuity",
      label: "Focus Continuity",
      score: focusFlowSummary.focusContinuityScore,
      summary: `Focus shifts remain deterministic at ${focusFlowSummary.focusContinuityScore}/100 continuity across the bounded cinematic phrase.`,
    }),
    buildGovernedPreviewIndicator({
      id: "subject-readability",
      label: "Subject Readability",
      score: focusFlowSummary.subjectReadabilityScore,
      summary: `Primary focus subjects remain readable at ${focusFlowSummary.subjectReadabilityScore}/100 without competing attention collapse.`,
    }),
    buildGovernedPreviewIndicator({
      id: "reveal-focus-preservation",
      label: "Reveal Focus Preservation",
      score: focusFlowSummary.revealFocusPreservationScore,
      summary: `Beacon reveal remains visually dominant at ${focusFlowSummary.revealFocusPreservationScore}/100 during the protected reveal window.`,
    }),
    buildGovernedPreviewIndicator({
      id: "drone-response-focus",
      label: "Drone Response Focus",
      score: focusFlowSummary.droneResponseFocusScore,
      summary: `Drone response stays readable at ${focusFlowSummary.droneResponseFocusScore}/100 once attention shifts away from the reveal.`,
    }),
    buildGovernedPreviewIndicator({
      id: "aftermath-focus-balance",
      label: "Aftermath Focus Balance",
      score: focusFlowSummary.aftermathFocusBalanceScore,
      summary: `Aftermath balance holds beacon residue and drone group together at ${focusFlowSummary.aftermathFocusBalanceScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "focus-camera-compatibility",
      label: "Focus Camera Compatibility",
      score: focusFlowSummary.focusCameraCompatibilityScore,
      summary: `Focus-flow hints stay advisory and camera-compatible at ${focusFlowSummary.focusCameraCompatibilityScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "tension-continuity",
      label: "Tension Continuity",
      score: tensionSummary.tensionContinuityScore,
      summary: `Tension progression remains deterministic at ${tensionSummary.tensionContinuityScore}/100 continuity across the cinematic phrase.`,
    }),
    buildGovernedPreviewIndicator({
      id: "tension-readability",
      label: "Tension Readability",
      score: tensionSummary.tensionReadabilityScore,
      summary: `Escalation and release remain readable at ${tensionSummary.tensionReadabilityScore}/100 without overwhelming focus or composition.`,
    }),
    buildGovernedPreviewIndicator({
      id: "reveal-peak-preservation",
      label: "Reveal Peak Preservation",
      score: tensionSummary.revealPeakPreservationScore,
      summary: `Beacon reveal peak holds at ${tensionSummary.revealPeakPreservationScore}/100 during the strongest pressure window.`,
    }),
    buildGovernedPreviewIndicator({
      id: "decay-stability",
      label: "Decay Stability",
      score: tensionSummary.decayStabilityScore,
      summary: `Aftermath decay remains controlled at ${tensionSummary.decayStabilityScore}/100 instead of collapsing abruptly.`,
    }),
    buildGovernedPreviewIndicator({
      id: "tension-camera-compatibility",
      label: "Tension Camera Compatibility",
      score: tensionSummary.tensionCameraCompatibilityScore,
      summary: `Tension hints stay advisory and camera-compatible at ${tensionSummary.tensionCameraCompatibilityScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "momentum-continuity",
      label: "Momentum Continuity",
      score: momentumSummary.momentumContinuityScore,
      summary: `Momentum flow preserves directional pacing at ${momentumSummary.momentumContinuityScore}/100 continuity across the phrase.`,
    }),
    buildGovernedPreviewIndicator({
      id: "momentum-readability",
      label: "Momentum Readability",
      score: momentumSummary.momentumReadabilityScore,
      summary: `Momentum propagation stays readable at ${momentumSummary.momentumReadabilityScore}/100 without overwhelming focus or tension.`,
    }),
    buildGovernedPreviewIndicator({
      id: "reveal-propagation",
      label: "Reveal Propagation",
      score: momentumSummary.revealPropagationScore,
      summary: `Reveal energy carries forward at ${momentumSummary.revealPropagationScore}/100 without creating a new beat.`,
    }),
    buildGovernedPreviewIndicator({
      id: "reaction-carryover",
      label: "Reaction Carryover",
      score: momentumSummary.reactionCarryoverScore,
      summary: `Drone response inherits reveal momentum at ${momentumSummary.reactionCarryoverScore}/100 carryover stability.`,
    }),
    buildGovernedPreviewIndicator({
      id: "decay-inertia",
      label: "Decay Inertia",
      score: momentumSummary.decayInertiaScore,
      summary: `Aftermath inertia settles at ${momentumSummary.decayInertiaScore}/100 without abrupt collapse.`,
    }),
    buildGovernedPreviewIndicator({
      id: "momentum-camera-compatibility",
      label: "Momentum Camera Compatibility",
      score: momentumSummary.momentumCameraCompatibilityScore,
      summary: `Momentum hints stay advisory and camera-compatible at ${momentumSummary.momentumCameraCompatibilityScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "transition-smoothness",
      label: "Transition Smoothness",
      score: transitionBlendSummary.transitionSmoothnessScore,
      summary: `Beat-to-beat transition blending stays smooth at ${transitionBlendSummary.transitionSmoothnessScore}/100 without breaking deterministic phrase structure.`,
    }),
    buildGovernedPreviewIndicator({
      id: "visual-continuity",
      label: "Visual Continuity",
      score: transitionBlendSummary.visualContinuityScore,
      summary: `Visual continuity holds at ${transitionBlendSummary.visualContinuityScore}/100 while blend hints stay bounded and advisory.`,
    }),
    buildGovernedPreviewIndicator({
      id: "reveal-transition-preservation",
      label: "Reveal Transition Preservation",
      score: transitionBlendSummary.revealTransitionPreservationScore,
      summary: `Reveal-to-response readability is preserved at ${transitionBlendSummary.revealTransitionPreservationScore}/100 through the transition window.`,
    }),
    buildGovernedPreviewIndicator({
      id: "response-to-aftermath",
      label: "Response To Aftermath",
      score: transitionBlendSummary.responseToAftermathScore,
      summary: `Response-to-aftermath blending remains stable at ${transitionBlendSummary.responseToAftermathScore}/100 without abrupt collapse.`,
    }),
    buildGovernedPreviewIndicator({
      id: "settle-blend-stability",
      label: "Settle Blend Stability",
      score: transitionBlendSummary.settleBlendStabilityScore,
      summary: `Aftermath-to-settle easing resolves at ${transitionBlendSummary.settleBlendStabilityScore}/100 with bounded stabilization.`,
    }),
    buildGovernedPreviewIndicator({
      id: "blend-camera-compatibility",
      label: "Blend Camera Compatibility",
      score: transitionBlendSummary.blendCameraCompatibilityScore,
      summary: `Transition-blend hints stay advisory and camera-compatible at ${transitionBlendSummary.blendCameraCompatibilityScore}/100.`,
    }),
    buildGovernedPreviewIndicator({
      id: "scene-visual-language",
      label: "Scene Visual Language",
      score: sceneCohesionSummary.visualLanguageScore,
      summary: `Scene-level visual language holds at ${sceneCohesionSummary.visualLanguageScore}/100 across the governed phrase instead of resetting each beat.`,
    }),
    buildGovernedPreviewIndicator({
      id: "scene-phrase-continuity",
      label: "Scene Phrase Continuity",
      score: sceneCohesionSummary.phraseContinuityScore,
      summary: `Phrase continuity remains deterministic at ${sceneCohesionSummary.phraseContinuityScore}/100 with rollback-safe scene identity preservation.`,
    }),
    buildGovernedPreviewIndicator({
      id: "scene-cohesion",
      label: "Scene Cohesion",
      score: sceneCohesionSummary.sceneCohesionScore,
      summary: `The whole preview reads as one cohesive scene at ${sceneCohesionSummary.sceneCohesionScore}/100 instead of disconnected beat fragments.`,
    }),
    buildGovernedPreviewIndicator({
      id: "environment-identity",
      label: "Environment Identity",
      score: sceneCohesionSummary.environmentIdentityScore,
      summary: `Environment identity remains stable at ${sceneCohesionSummary.environmentIdentityScore}/100 while chamber lighting and residue stay bounded.`,
    }),
    buildGovernedPreviewIndicator({
      id: "formation-identity",
      label: "Formation Identity",
      score: sceneCohesionSummary.formationIdentityScore,
      summary: `Formation identity holds at ${sceneCohesionSummary.formationIdentityScore}/100 while drone choreography remains advisory-only.`,
    }),
    buildGovernedPreviewIndicator({
      id: "final-composition",
      label: "Final Composition",
      score: sceneCohesionSummary.finalCompositionScore,
      summary: `Final composition stability resolves at ${sceneCohesionSummary.finalCompositionScore}/100 without scene drift at the end of the phrase.`,
    }),
    buildGovernedPreviewIndicator({
      id: "cohesion-camera-compatibility",
      label: "Cohesion Camera Compatibility",
      score: sceneCohesionSummary.cohesionCameraCompatibilityScore,
      summary: `Scene-cohesion hints stay advisory and camera-compatible at ${sceneCohesionSummary.cohesionCameraCompatibilityScore}/100.`,
    }),
  ];
  ...
  return {
    ...
    cinematic_staging_summary: stagingDiagnostics.length > 0 ? stagingSummary.cinematicStagingSummary : undefined,
    cinematic_focus_flow_summary: focusFlowDiagnostics.length > 0 ? focusFlowSummary.cinematicFocusFlowSummary : undefined,
    cinematic_tension_curve_summary: tensionDiagnostics.length > 0 ? tensionSummary.cinematicTensionCurveSummary : undefined,
    cinematic_momentum_flow_summary: momentumDiagnostics.length > 0 ? momentumSummary.cinematicMomentumFlowSummary : undefined,
    cinematic_transition_blend_summary: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.cinematicTransitionBlendSummary : undefined,
    cinematic_scene_cohesion_summary: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.cinematicSceneCohesionSummary : undefined,
    ...
    active_beat_type: stagingDiagnostics.length > 0 ? stagingSummary.activeBeatType : undefined,
    active_focus_subject: focusFlowDiagnostics.length > 0 ? focusFlowSummary.activeFocusSubject : undefined,
    previous_focus_subject: focusFlowDiagnostics.length > 0 ? focusFlowSummary.previousFocusSubject : undefined,
    active_tension_phase: tensionDiagnostics.length > 0 ? tensionSummary.activeTensionPhase : undefined,
    active_momentum_phase: momentumDiagnostics.length > 0 ? momentumSummary.activeMomentumPhase : undefined,
    active_blend_phase: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.activeBlendPhase : undefined,
    active_scene_identity: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.activeSceneIdentity : undefined,
    from_beat: transitionBlendDiagnostics.length > 0 ? (transitionBlendSummary.fromBeat as CinematicBeatType) : undefined,
    to_beat: transitionBlendDiagnostics.length > 0 ? (transitionBlendSummary.toBeat as CinematicBeatType) : undefined,
    beat_phase: stagingDiagnostics.length > 0 ? stagingSummary.beatPhase : undefined,
    focus_subject: stagingDiagnostics.length > 0 ? stagingSummary.focusSubject : undefined,
    focus_transition_phase: focusFlowDiagnostics.length > 0 ? focusFlowSummary.focusTransitionPhase : undefined,
    focus_priority_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.focusPriorityScore : undefined,
    focus_continuity_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.focusContinuityScore : undefined,
    subject_readability_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.subjectReadabilityScore : undefined,
    reveal_focus_preservation_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.revealFocusPreservationScore : undefined,
    drone_response_focus_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.droneResponseFocusScore : undefined,
    aftermath_focus_balance_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.aftermathFocusBalanceScore : undefined,
    focus_camera_compatibility_score: focusFlowDiagnostics.length > 0 ? focusFlowSummary.focusCameraCompatibilityScore : undefined,
    tension_intensity: tensionDiagnostics.length > 0 ? tensionSummary.tensionIntensity : undefined,
    escalation_rate: tensionDiagnostics.length > 0 ? tensionSummary.escalationRate : undefined,
    release_rate: tensionDiagnostics.length > 0 ? tensionSummary.releaseRate : undefined,
    tension_continuity_score: tensionDiagnostics.length > 0 ? tensionSummary.tensionContinuityScore : undefined,
    tension_readability_score: tensionDiagnostics.length > 0 ? tensionSummary.tensionReadabilityScore : undefined,
    reveal_peak_preservation_score: tensionDiagnostics.length > 0 ? tensionSummary.revealPeakPreservationScore : undefined,
    decay_stability_score: tensionDiagnostics.length > 0 ? tensionSummary.decayStabilityScore : undefined,
    tension_focus_compatibility_score: tensionDiagnostics.length > 0 ? tensionSummary.tensionFocusCompatibilityScore : undefined,
    tension_camera_compatibility_score: tensionDiagnostics.length > 0 ? tensionSummary.tensionCameraCompatibilityScore : undefined,
    momentum_intensity: momentumDiagnostics.length > 0 ? momentumSummary.momentumIntensity : undefined,
    propagation_rate: momentumDiagnostics.length > 0 ? momentumSummary.propagationRate : undefined,
    stabilization_rate: momentumDiagnostics.length > 0 ? momentumSummary.stabilizationRate : undefined,
    momentum_continuity_score: momentumDiagnostics.length > 0 ? momentumSummary.momentumContinuityScore : undefined,
    momentum_readability_score: momentumDiagnostics.length > 0 ? momentumSummary.momentumReadabilityScore : undefined,
    reveal_propagation_score: momentumDiagnostics.length > 0 ? momentumSummary.revealPropagationScore : undefined,
    reaction_carryover_score: momentumDiagnostics.length > 0 ? momentumSummary.reactionCarryoverScore : undefined,
    decay_inertia_score: momentumDiagnostics.length > 0 ? momentumSummary.decayInertiaScore : undefined,
    momentum_camera_compatibility_score: momentumDiagnostics.length > 0 ? momentumSummary.momentumCameraCompatibilityScore : undefined,
    blend_progress: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.blendProgress : undefined,
    blend_weight: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.blendWeight : undefined,
    transition_smoothness_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.transitionSmoothnessScore : undefined,
    visual_continuity_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.visualContinuityScore : undefined,
    reveal_transition_preservation_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.revealTransitionPreservationScore : undefined,
    response_to_aftermath_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.responseToAftermathScore : undefined,
    settle_blend_stability_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.settleBlendStabilityScore : undefined,
    blend_camera_compatibility_score: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.blendCameraCompatibilityScore : undefined,
    cohesion_weight: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.cohesionWeight : undefined,
    visual_language_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.visualLanguageScore : undefined,
    phrase_continuity_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.phraseContinuityScore : undefined,
    scene_cohesion_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.sceneCohesionScore : undefined,
    environment_identity_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.environmentIdentityScore : undefined,
    formation_identity_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.formationIdentityScore : undefined,
    final_composition_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.finalCompositionScore : undefined,
    cohesion_camera_compatibility_score: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.cohesionCameraCompatibilityScore : undefined,
    staging_intensity: stagingDiagnostics.length > 0 ? stagingSummary.stagingIntensity : undefined,
    ...
    silhouette_readability_score: articulatedSummary.silhouetteReadabilityScore,
    ...
    emphasis_score: stagingDiagnostics.length > 0 ? stagingSummary.emphasisScore : undefined,
    beat_readability_score: stagingDiagnostics.length > 0 ? stagingSummary.beatReadabilityScore : undefined,
    focus_persistence_score: stagingDiagnostics.length > 0 ? stagingSummary.focusPersistenceScore : undefined,
    event_focus_alignment_score: stagingDiagnostics.length > 0 ? stagingSummary.eventFocusAlignmentScore : undefined,
    staging_camera_compatibility_score: stagingDiagnostics.length > 0 ? stagingSummary.stagingCameraCompatibilityScore : undefined,
    rollback_restored_staging: stagingDiagnostics.length > 0 ? stagingSummary.rollbackRestoredStaging : undefined,
    rollback_restored_focus: focusFlowDiagnostics.length > 0 ? focusFlowSummary.rollbackRestoredFocus : undefined,
    rollback_restored_tension: tensionDiagnostics.length > 0 ? tensionSummary.rollbackRestoredTension : undefined,
    rollback_restored_momentum: momentumDiagnostics.length > 0 ? momentumSummary.rollbackRestoredMomentum : undefined,
    rollback_restored_blend: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.rollbackRestoredBlend : undefined,
    rollback_restored_cohesion: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.rollbackRestoredCohesion : undefined,
    rejected_staging_transition_count: stagingDiagnostics.length > 0 ? stagingSummary.rejectedStagingTransitionCount : undefined,
    rejected_focus_transition_count: focusFlowDiagnostics.length > 0 ? focusFlowSummary.rejectedFocusTransitionCount : undefined,
    rejected_tension_transition_count: tensionDiagnostics.length > 0 ? tensionSummary.rejectedTensionTransitionCount : undefined,
    rejected_momentum_transition_count: momentumDiagnostics.length > 0 ? momentumSummary.rejectedMomentumTransitionCount : undefined,
    rejected_blend_transition_count: transitionBlendDiagnostics.length > 0 ? transitionBlendSummary.rejectedBlendTransitionCount : undefined,
    rejected_cohesion_transition_count: sceneCohesionDiagnostics.length > 0 ? sceneCohesionSummary.rejectedCohesionTransitionCount : undefined,
    reaction_continuity_score: reactionContinuityScore,
    event_causality_score: eventCausalityScore,
    camera_event_framing_score: cameraEventFramingScore,
    rollback_integrity_status: stagingDiagnostics.length > 0 || focusFlowDiagnostics.length > 0
      ? (
        stagingSummary.rollbackIntegrityStatus === "PASS"
        && focusFlowSummary.rollbackIntegrityStatus === "PASS"
        && tensionSummary.rollbackIntegrityStatus === "PASS"
        && momentumSummary.rollbackIntegrityStatus === "PASS"
        && transitionBlendSummary.rollbackIntegrityStatus === "PASS"
        && sceneCohesionSummary.rollbackIntegrityStatus === "PASS"
        && (multiEntityDiagnostics.length === 0 || multiEntitySummary.rollbackIntegrityStatus === "PASS")
          ? "PASS"
          : "WATCH"
      )
      : (multiEntityDiagnostics.length > 0 ? multiEntitySummary.rollbackIntegrityStatus : articulatedSummary.rollbackIntegrityStatus),
...
function renderGovernedPrimitiveScene(input: {
  ...
  previousStagingSnapshot?: CinematicStagingSnapshot | null;
  previousFocusFlowSnapshot?: CinematicFocusFlowSnapshot | null;
  previousTensionSnapshot?: CinematicTensionSnapshot | null;
  previousMomentumSnapshot?: CinematicMomentumSnapshot | null;
  previousTransitionBlendSnapshot?: CinematicTransitionBlendSnapshot | null;
  previousSceneCohesionSnapshot?: CinematicSceneCohesionSnapshot | null;
  ...
  const stagingBeat = buildDeterministicEventBeat({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
  });
  const seedFormationPlan = buildGovernedFormationPlan({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    width: input.width,
    height: input.height,
    formationEmphasis: stagingBeat.formationEmphasis,
  ...
  const stagingFrame = computeCinematicStagingFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    width: input.width,
    ...
    beaconX: baseBeaconCenterX,
    beaconY: baseBeaconCenterY,
    groupHint: seedFormationPlan.cameraHint,
    cameraContinuityScore: input.previousCameraSnapshot?.cameraState.continuityScore ?? 100,
    cameraFramingScore: input.previousCameraSnapshot?.framingState.framingScore ?? 100,
    reactionContinuityScore: input.previousMultiEntitySnapshot?.diagnostics.choreographyContinuityScore ?? 100,
    previousSnapshot: input.previousStagingSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 4,
  });
  const focusFlowFrame = computeGovernedFocusFlowFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    width: input.width,
    height: input.height,
    beatType: stagingBeat.beatType,
    beatPhase: stagingBeat.beatPhase,
    cubeAnchorX: baseAnchorX,
    cubeAnchorY: baseAnchorY,
    beaconX: baseBeaconCenterX,
    beaconY: baseBeaconCenterY,
    groupHint: seedFormationPlan.cameraHint,
    stagingHint: stagingFrame.hint,
    cameraContinuityScore: input.previousCameraSnapshot?.cameraState.continuityScore ?? 100,
    cameraFramingScore: input.previousCameraSnapshot?.framingState.framingScore ?? 100,
    reactionContinuityScore: input.previousMultiEntitySnapshot?.diagnostics.choreographyContinuityScore ?? 100,
    previousSnapshot: input.previousFocusFlowSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 3,
  });
  const tensionFrame = computeGovernedTensionCurveFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    beatType: stagingBeat.beatType,
    ...
    cameraFramingScore: input.previousCameraSnapshot?.framingState.framingScore ?? 100,
    reactionContinuityScore: input.previousMultiEntitySnapshot?.diagnostics.choreographyContinuityScore ?? 100,
    focusContinuityScore: focusFlowFrame.diagnostics.focusContinuityScore,
    focusReadabilityScore: focusFlowFrame.diagnostics.subjectReadabilityScore,
    previousSnapshot: input.previousTensionSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 2,
  });
  const momentumFrame = computeGovernedMomentumFlowFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    beatType: stagingBeat.beatType,
    ...
    focusContinuityScore: focusFlowFrame.diagnostics.focusContinuityScore,
    focusReadabilityScore: focusFlowFrame.diagnostics.subjectReadabilityScore,
    tensionContinuityScore: tensionFrame.diagnostics.tensionContinuityScore,
    tensionReadabilityScore: tensionFrame.diagnostics.tensionReadabilityScore,
    tensionCameraCompatibilityScore: tensionFrame.diagnostics.tensionCameraCompatibilityScore,
    previousSnapshot: input.previousMomentumSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 3,
  });
  const transitionBlendFrame = computeGovernedTransitionBlendFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    beatType: stagingBeat.beatType,
    ...
    focusReadabilityScore: focusFlowFrame.diagnostics.subjectReadabilityScore,
    tensionContinuityScore: tensionFrame.diagnostics.tensionContinuityScore,
    momentumContinuityScore: momentumFrame.diagnostics.momentumContinuityScore,
    momentumReadabilityScore: momentumFrame.diagnostics.momentumReadabilityScore,
    previousSnapshot: input.previousTransitionBlendSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 3,
  });
  const sceneCohesionFrame = computeGovernedSceneCohesionFrame({
    frameIndex: input.frameIndex,
    totalFrames: input.totalFrames,
    mode: input.mode,
    beatType: stagingBeat.beatType,
    ...
    momentumContinuityScore: momentumFrame.diagnostics.momentumContinuityScore,
    momentumReadabilityScore: momentumFrame.diagnostics.momentumReadabilityScore,
    blendTransitionSmoothnessScore: transitionBlendFrame.diagnostics.transitionSmoothnessScore,
    blendVisualContinuityScore: transitionBlendFrame.diagnostics.visualContinuityScore,
    blendCameraCompatibilityScore: transitionBlendFrame.diagnostics.blendCameraCompatibilityScore,
    previousSnapshot: input.previousSceneCohesionSnapshot,
    injectInvalidTransition: input.mode === "motion-preview" && input.frameIndex === 4,
  });
  const formationPlan = buildGovernedFormationPlan({
    ...
    width: input.width,
    height: input.height,
    formationEmphasis: stagingFrame.hint.formationEmphasis + focusFlowFrame.hint.formationResponseEmphasis * 0.22 + tensionFrame.hint.reactionEnergyPreference * 0.12 + momentumFrame.hint.movementCarryoverPreference * 0.08 + transitionBlendFrame.hint.formationTransitionPreference * 0.06 + sceneCohesionFrame.hint.formationIdentityPreference * 0.06,
    beaconClearancePreference: Math.max(focusFlowFrame.hint.revealProtectionPreference, tensionFrame.hint.revealProtectionPreference),
    groupReadabilityPreference: Math.max(focusFlowFrame.hint.groupReadabilityPreference, tensionFrame.hint.pressureReadabilityPriority, momentumFrame.hint.pacingContinuityPreference, transitionBlendFrame.hint.visualContinuityPriority),
    compositionBalancePreference: Math.max(focusFlowFrame.hint.compositionPreference, tensionFrame.hint.settleCompositionPreference),
    reactionEnergyPreference: Math.max(tensionFrame.hint.reactionEnergyPreference, momentumFrame.hint.movementCarryoverPreference, transitionBlendFrame.hint.revealToResponseCarryPreference),
    formationCompressionPreference: tensionFrame.hint.formationCompressionPreference,
    movementCarryoverPreference: momentumFrame.hint.movementCarryoverPreference,
    formationExpansionPreference: momentumFrame.hint.formationExpansionPreference,
    transitionSoftnessPreference: transitionBlendFrame.hint.transitionSoftnessPreference,
    settleStabilizationPreference: transitionBlendFrame.hint.settleStabilizationPreference,
    formationIdentityPreference: sceneCohesionFrame.hint.formationIdentityPreference,
    environmentIdentityIntensity: sceneCohesionFrame.hint.environmentIdentityIntensity,
    residueContinuityPreference: sceneCohesionFrame.hint.residueContinuityPreference,
    chamberCenterX: input.width * 0.5,
    horizonY: input.height * 0.68,
    platformY: basePlatformY,
    cubeAnchorX: baseAnchorX,
  ...
  const rigFrame = computeGovernedCameraRigFrame({
    ...
    focusX: focusFlowFrame.hint.focusCenterX * 0.58 + stagingFrame.hint.focusCenterX * 0.42,
    focusY: focusFlowFrame.hint.focusCenterY * 0.58 + stagingFrame.hint.focusCenterY * 0.42,
    focusRadius: focusFlowFrame.hint.focusRadius * 0.6 + stagingFrame.hint.focusRadius * 0.4,
    focusSubjectPriority: focusFlowFrame.hint.focusSubjectPriority,
    revealPreference: Math.max(stagingFrame.hint.revealPreference, focusFlowFrame.hint.revealProtectionPreference),
    revealProtectionPreference: focusFlowFrame.hint.revealProtectionPreference,
    groupReadabilityPreference: focusFlowFrame.hint.groupReadabilityPreference,
    escalationFramingPreference: tensionFrame.hint.escalationFramingPreference,
    propagationFramingPreference: momentumFrame.hint.propagationFramingPreference,
    revealCarryoverPreference: momentumFrame.hint.revealCarryoverPreference,
    transitionSoftnessPreference: transitionBlendFrame.hint.transitionSoftnessPreference,
    revealToResponseCarryPreference: transitionBlendFrame.hint.revealToResponseCarryPreference,
    decayStabilizationPreference: tensionFrame.hint.decayStabilizationPreference,
    inertiaStabilizationPreference: momentumFrame.hint.inertiaStabilizationPreference,
    aftermathEasingPreference: transitionBlendFrame.hint.aftermathEasingPreference,
    settleCompositionPreference: tensionFrame.hint.settleCompositionPreference,
    settleRecoveryPreference: momentumFrame.hint.settleRecoveryPreference,
    settleStabilizationPreference: transitionBlendFrame.hint.settleStabilizationPreference,
    sceneIdentityFramingPreference: sceneCohesionFrame.hint.sceneIdentityFramingPreference,
    globalCompositionConsistencyPreference: sceneCohesionFrame.hint.globalCompositionConsistencyPreference,
    chamberReadabilityPreference: sceneCohesionFrame.hint.chamberReadabilityPreference,
    finalCompositionStabilizationPreference: sceneCohesionFrame.hint.finalCompositionStabilizationPreference,
    phraseLevelContinuityPriority: sceneCohesionFrame.hint.phraseLevelContinuityPriority,
    pressureReadabilityPriority: tensionFrame.hint.pressureReadabilityPriority,
    pacingContinuityPreference: momentumFrame.hint.pacingContinuityPreference,
    visualContinuityPriority: transitionBlendFrame.hint.visualContinuityPriority,
    compositionPriority: Math.max(stagingFrame.hint.compositionPriority, focusFlowFrame.hint.compositionPreference),
    chamberCenterX: input.width * 0.5,
  ...
  const roomPulse = (input.mode === "motion-preview" ? 1.02 : 0.86)
    + stagingFrame.hint.environmentEmphasis * 0.14
    + focusFlowFrame.hint.environmentResponseIntensity * 0.09
    + tensionFrame.hint.environmentResponseIntensity * 0.12
    + momentumFrame.hint.environmentPropagationIntensity * 0.1
    + transitionBlendFrame.hint.environmentResiduePreference * 0.08
    + sceneCohesionFrame.hint.environmentIdentityIntensity * 0.08;
  for (let y = 0; y < input.height; y += 1) {
    const verticalProgress = y / Math.max(1, input.height - 1);
    for (let x = 0; x < input.width; x += 1) {
      const horizontalDistance = Math.abs(x - input.width / 2) / (input.width / 2);
      const fog = Math.max(0, 1 - Math.sqrt(horizontalDistance * horizontalDistance + Math.pow((y - input.height * 0.5) / input.height, 2)) * (1.35 - tensionFrame.hint.environmentResponseIntensity * 0.08 - momentumFrame.hint.environmentPropagationIntensity * 0.05 - transitionBlendFrame.hint.environmentResiduePreference * 0.04 - sceneCohesionFrame.hint.environmentIdentityIntensity * 0.04 - sceneCohesionFrame.hint.residueContinuityPreference * 0.03));
  ...
  const multiEntityScene = computeGovernedMultiEntitySceneFrame({
    ...
    horizonY,
    platformY: basePlatformY,
    cubeAnchorX: baseAnchorX - cameraDriftX * 0.88,
    cubeAnchorY: baseAnchorY - cameraDriftY * 0.68,
    beaconX: baseBeaconCenterX - cameraDriftX * 0.92,
    ...
    formationEmphasis: stagingFrame.hint.formationEmphasis + focusFlowFrame.hint.formationResponseEmphasis * 0.22 + momentumFrame.hint.movementCarryoverPreference * 0.08 + transitionBlendFrame.hint.formationTransitionPreference * 0.06 + sceneCohesionFrame.hint.formationIdentityPreference * 0.06,
  });
  ...
  const fogDensity = (input.mode === "motion-preview" ? 0.24 : 0.2)
    + stagingFrame.hint.environmentEmphasis * 0.06
    + focusFlowFrame.hint.environmentResponseIntensity * 0.08;
  ...
  const beaconInfluenceStrength = Math.min(0.98, Math.max(0.58, (0.46 + beaconHorizontalProximity * 0.28 + beaconVerticalCoupling * 0.24) * (0.94 + stagingFrame.hint.environmentEmphasis * 0.16)));
  const reactiveLightRadius = orbitRadius * (input.mode === "motion-preview" ? 1.08 : 1.02) * (0.94 + stagingFrame.hint.environmentEmphasis * 0.18 + focusFlowFrame.hint.environmentResponseIntensity * 0.1);
  ...
  return {
    ...
    diagnostic: {
      ...
      active_beat_type: stagingBeat.beatType,
      active_focus_subject: focusFlowFrame.state.activeFocusSubject,
      previous_focus_subject: focusFlowFrame.state.previousFocusSubject,
      active_tension_phase: tensionFrame.state.activeTensionPhase,
      active_momentum_phase: momentumFrame.state.activeMomentumPhase,
      active_blend_phase: transitionBlendFrame.state.activeBlendPhase,
      active_scene_identity: sceneCohesionFrame.state.activeSceneIdentity,
      ...
      from_beat: transitionBlendFrame.state.fromBeat,
      to_beat: transitionBlendFrame.state.toBeat,
      beat_phase: Number(stagingBeat.beatPhase.toFixed(2)),
      focus_subject: stagingFrame.state.focusSubject,
      focus_transition_phase: focusFlowFrame.state.focusTransitionPhase,
      focus_priority_score: focusFlowFrame.state.focusPriorityScore,
      focus_continuity_score: focusFlowFrame.state.focusContinuityScore,
      subject_readability_score: focusFlowFrame.state.subjectReadabilityScore,
      reveal_focus_preservation_score: focusFlowFrame.diagnostics.revealFocusPreservationScore,
      drone_response_focus_score: focusFlowFrame.diagnostics.droneResponseFocusScore,
      aftermath_focus_balance_score: focusFlowFrame.diagnostics.aftermathFocusBalanceScore,
      focus_camera_compatibility_score: focusFlowFrame.diagnostics.focusCameraCompatibilityScore,
      tension_intensity: tensionFrame.state.tensionIntensity,
      escalation_rate: tensionFrame.state.escalationRate,
      release_rate: tensionFrame.state.releaseRate,
      tension_continuity_score: tensionFrame.state.tensionContinuityScore,
      tension_readability_score: tensionFrame.state.tensionReadabilityScore,
      reveal_peak_preservation_score: tensionFrame.diagnostics.revealPeakPreservationScore,
      decay_stability_score: tensionFrame.diagnostics.decayStabilityScore,
      tension_focus_compatibility_score: tensionFrame.diagnostics.tensionFocusCompatibilityScore,
      tension_camera_compatibility_score: tensionFrame.diagnostics.tensionCameraCompatibilityScore,
      momentum_intensity: momentumFrame.state.momentumIntensity,
      propagation_rate: momentumFrame.state.propagationRate,
      stabilization_rate: momentumFrame.state.stabilizationRate,
      momentum_continuity_score: momentumFrame.state.momentumContinuityScore,
      momentum_readability_score: momentumFrame.state.momentumReadabilityScore,
      reveal_propagation_score: momentumFrame.diagnostics.revealPropagationScore,
      reaction_carryover_score: momentumFrame.diagnostics.reactionCarryoverScore,
      decay_inertia_score: momentumFrame.diagnostics.decayInertiaScore,
      momentum_camera_compatibility_score: momentumFrame.diagnostics.momentumCameraCompatibilityScore,
      blend_progress: transitionBlendFrame.state.blendProgress,
      blend_weight: transitionBlendFrame.state.blendWeight,
      transition_smoothness_score: transitionBlendFrame.state.transitionSmoothnessScore,
      visual_continuity_score: transitionBlendFrame.state.visualContinuityScore,
      reveal_transition_preservation_score: transitionBlendFrame.diagnostics.revealTransitionPreservationScore,
      response_to_aftermath_score: transitionBlendFrame.diagnostics.responseToAftermathScore,
      settle_blend_stability_score: transitionBlendFrame.diagnostics.settleBlendStabilityScore,
      blend_camera_compatibility_score: transitionBlendFrame.diagnostics.blendCameraCompatibilityScore,
      cohesion_weight: sceneCohesionFrame.state.cohesionWeight,
      visual_language_score: sceneCohesionFrame.diagnostics.visualLanguageScore,
      phrase_continuity_score: sceneCohesionFrame.diagnostics.phraseContinuityScore,
      scene_cohesion_score: sceneCohesionFrame.diagnostics.sceneCohesionScore,
      environment_identity_score: sceneCohesionFrame.diagnostics.environmentIdentityScore,
      formation_identity_score: sceneCohesionFrame.diagnostics.formationIdentityScore,
      final_composition_score: sceneCohesionFrame.diagnostics.finalCompositionScore,
      cohesion_camera_compatibility_score: sceneCohesionFrame.diagnostics.cohesionCameraCompatibilityScore,
      staging_intensity: Number(stagingFrame.state.stagingIntensity.toFixed(2)),
      ...
      emphasis_score: stagingFrame.diagnostics.emphasisScore,
      beat_readability_score: stagingFrame.diagnostics.beatReadabilityScore,
      focus_persistence_score: stagingFrame.diagnostics.focusPersistenceScore,
      event_focus_alignment_score: stagingFrame.diagnostics.eventFocusAlignmentScore,
      staging_camera_compatibility_score: stagingFrame.diagnostics.stagingCameraCompatibilityScore,
      rejected_staging_transition_count: stagingFrame.diagnostics.rejectedStagingTransitionCount,
      rejected_focus_transition_count: focusFlowFrame.diagnostics.rejectedFocusTransitionCount,
      rejected_tension_transition_count: tensionFrame.diagnostics.rejectedTensionTransitionCount,
      rejected_momentum_transition_count: momentumFrame.diagnostics.rejectedMomentumTransitionCount,
      rejected_blend_transition_count: transitionBlendFrame.diagnostics.rejectedBlendTransitionCount,
      rejected_cohesion_transition_count: sceneCohesionFrame.diagnostics.rejectedCohesionTransitionCount,
      ...
      rollback_restored_staging: stagingFrame.diagnostics.rollbackRestoredStaging,
      rollback_restored_focus: focusFlowFrame.diagnostics.rollbackRestoredFocus,
      rollback_restored_tension: tensionFrame.diagnostics.rollbackRestoredTension,
      rollback_restored_momentum: momentumFrame.diagnostics.rollbackRestoredMomentum,
      rollback_restored_blend: transitionBlendFrame.diagnostics.rollbackRestoredBlend,
      rollback_restored_cohesion: sceneCohesionFrame.diagnostics.rollbackRestoredCohesion,
      ...
      cinematic_staging_overlay: stagingFrame.diagnostics.overlay,
      cinematic_focus_flow_overlay: focusFlowFrame.diagnostics.overlay,
      cinematic_tension_curve_overlay: tensionFrame.diagnostics.overlay,
      cinematic_momentum_flow_overlay: momentumFrame.diagnostics.overlay,
      cinematic_transition_blend_overlay: transitionBlendFrame.diagnostics.overlay,
      cinematic_scene_cohesion_overlay: sceneCohesionFrame.diagnostics.overlay,
    ...
    stagingSnapshot: stagingFrame.snapshot,
    focusFlowSnapshot: focusFlowFrame.snapshot,
    tensionSnapshot: tensionFrame.snapshot,
    momentumSnapshot: momentumFrame.snapshot,
    transitionBlendSnapshot: transitionBlendFrame.snapshot,
    sceneCohesionSnapshot: sceneCohesionFrame.snapshot,
  };
}
...
async function executeGovernedMicroSequenceSandbox(input: {
  ...
  await mkdir(outputRoot, { recursive: true });
  const sequenceDirectory = containment?.sequence_id ?? "sequence-unset";
  const absoluteSequenceDirectory = path.join(outputRoot, sequenceDirectory);
  const deletedOutputTargets: string[] = [];
  for (const entry of await readdir(outputRoot)) {
    const childPath = path.join(outputRoot, entry);
    if (childPath !== absoluteSequenceDirectory) {
      await rm(childPath, { recursive: true, force: true });
      deletedOutputTargets.push(path.relative(input.root, childPath).replace(/\\/g, "/"));
    }
  }
  await rm(absoluteSequenceDirectory, { recursive: true, force: true });
  await mkdir(absoluteSequenceDirectory, { recursive: true });
  ...
  let previousStagingSnapshot: CinematicStagingSnapshot | null = null;
  let previousFocusFlowSnapshot: CinematicFocusFlowSnapshot | null = null;
  let previousTensionSnapshot: CinematicTensionSnapshot | null = null;
  let previousMomentumSnapshot: CinematicMomentumSnapshot | null = null;
  let previousTransitionBlendSnapshot: CinematicTransitionBlendSnapshot | null = null;
  let previousSceneCohesionSnapshot: CinematicSceneCohesionSnapshot | null = null;
  ...
  if (realSequenceWritten) {
    ...
    for (let frameIndex = 0; frameIndex < frameCount; frameIndex += 1) {
      const renderedFrame = renderGovernedPrimitiveScene({
        ...
        previousFocusFlowSnapshot,
        previousTensionSnapshot,
        previousMomentumSnapshot,
        previousTransitionBlendSnapshot,
        previousSceneCohesionSnapshot,
      });
      ...
      previousStagingSnapshot = renderedFrame.stagingSnapshot;
      previousFocusFlowSnapshot = renderedFrame.focusFlowSnapshot;
      previousTensionSnapshot = renderedFrame.tensionSnapshot;
      previousMomentumSnapshot = renderedFrame.momentumSnapshot;
      previousTransitionBlendSnapshot = renderedFrame.transitionBlendSnapshot;
      previousSceneCohesionSnapshot = renderedFrame.sceneCohesionSnapshot;
    }
  ...
  return {
    sandbox_id: `governed-micro-sequence-sandbox-${Date.now()}`,
    recorded_at: new Date().toISOString(),
    sequence_id: containment?.sequence_id ?? null,
...
function buildContinuityPreviewSequencingPath(input: {
  sequenceContainment: CinematicContinuitySequenceContainmentRegistryEntry[];
  microSequenceSandbox: CinematicGovernedMicroSequenceSandbox;
  continuityValidation: CinematicFrameToFrameContinuityValidation;
}): CinematicContinuityPreviewSequencingPath {
  const containment = input.sequenceContainment[0] ?? null;
  const stages: CinematicContinuityPreviewSequencingStage[] = [
    "continuity_sequence_request",
    "continuity_anchor_prepare",
    "frame_sequence_stage",
    "continuity_validation_stage",
  ...
  return {
    path_id: `continuity-preview-sequencing-${Date.now()}`,
    recorded_at: new Date().toISOString(),
    sequence_id: containment?.sequence_id ?? null,
    output_file_paths: input.microSequenceSandbox.output_file_paths,
    stages: stages.map((stage, index) => ({
      stage,
      order: index + 1,
      status: stage === "rollback_ready"
        ? "rollback_ready"
        : stage === "sequence_archived"
          ? "archived"
          : input.microSequenceSandbox.real_sequence_written
            ? "completed"
            : stage === "continuity_sequence_request"
              ? "ready"
              : "blocked",
      detail: stage === "continuity_anchor_prepare"
        ? `Continuity anchor policy: ${containment?.continuity_anchor_policy ?? "none"}.`
        : stage === "bounded_sequence_write"
          ? `Bounded sequence written to ${input.microSequenceSandbox.sequence_directory}.`
          : stage === "rollback_ready"
            ? `Rollback window remains ${containment?.rollback_window ?? 0} frames.`
            : stage === "sequence_archived"
              ? "The governed continuity preview sequence is archived append-only after bounded execution."
              : `Stage ${stage} remains governed by sequence containment ${containment?.sequence_id ?? "none"}.`,
      blockers: input.microSequenceSandbox.real_sequence_written ? [] : input.continuityValidation.blocked_transitions,
    })),
    next_stage: input.microSequenceSandbox.real_sequence_written ? "rollback_ready" : "continuity_sequence_request",
  };
}

function buildSequenceRollbackRecoveryLayer(input: {
  sequenceContainment: CinematicContinuitySequenceContainmentRegistryEntry[];
  microSequenceSandbox: CinematicGovernedMicroSequenceSandbox;
  continuityPreviewSequencing: CinematicContinuityPreviewSequencingPath;
  continuityValidation: CinematicFrameToFrameContinuityValidation;
}): CinematicSequenceRollbackRecoveryLayer {
  const containment = input.sequenceContainment[0] ?? null;
  return {
    recovery_id: `sequence-rollback-recovery-${Date.now()}`,
    recorded_at: new Date().toISOString(),
    actions: [
      {
        action: "sequence-rollback-cleanup",
        triggered: input.microSequenceSandbox.real_sequence_written,
        detail: "Sequence rollback cleanup can remove the bounded preview sequence without affecting other outputs.",
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
      {
        action: "bounded-sequence-deletion",
        triggered: input.microSequenceSandbox.real_sequence_written,
        detail: "Bounded sequence deletion remains limited to the sandboxed micro-sequence directory.",
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
      {
        action: "continuity-reset-recovery",
        triggered: true,
        detail: `Continuity anchor reset remains governed by ${containment?.continuity_anchor_policy ?? "unset"}.`,
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
      {
        action: "rollback-authority-enforcement",
        triggered: containment !== null,
        detail: `Rollback window remains ${containment?.rollback_window ?? 0} frames for governed cleanup.`,
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
      {
        action: "sequence-attempt-archival",
        triggered: input.continuityPreviewSequencing.stages.some((entry) => entry.stage === "sequence_archived"),
        detail: "Micro-sequence attempts are always archived append-only after execution or block.",
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
      {
        action: "containment-violation-recovery",
        triggered: input.continuityValidation.blocked_transitions.length > 0,
        detail: "Containment violations route through bounded rollback and continuity reset recovery.",
        affected_output_targets: input.microSequenceSandbox.output_file_paths,
      },
    ],
  };
...
function buildFutureCinematicContinuityScaffolding(input: {
  sequenceContainment: CinematicContinuitySequenceContainmentRegistryEntry[];
  continuityValidation: CinematicFrameToFrameContinuityValidation;
}): CinematicFutureCinematicContinuityScaffolding {
  const forbidden = uniqueNormalizedStrings(input.sequenceContainment.flatMap((entry) => entry.forbidden_sequence_behaviors));
  const blockers = uniqueNormalizedStrings(input.continuityValidation.checks.filter((entry) => !entry.passed).flatMap((entry) => entry.blockers));
  const milestone = "reviewed-governed-cinematic-continuity-bridge";
  return {
    scaffold_id: `future-cinematic-continuity-${Date.now()}`,
    recorded_at: new Date().toISOString(),
    milestone_unlocks_cinematic_continuity: milestone,
    entries: [
      {
        continuity_id: "governed-teaser-preview-mode",
        unlocked: false,
        prerequisites: uniqueNormalizedStrings(["teaser-preview governance approval", ...blockers]),
        still_forbidden_operations: forbidden,
      },
      {
        continuity_id: "continuity-safe-trailer-sequencing",
        unlocked: false,
        prerequisites: ["trailer continuity review", "extended rollback coverage"],
        still_forbidden_operations: forbidden,
      },
      {
        continuity_id: "governed-dialogue-scene-previews",
        unlocked: false,
        prerequisites: ["dialogue-scene preview governance approval", "anchor-consistency proof"],
        still_forbidden_operations: forbidden,
      },
      {
        continuity_id: "continuity-preserving-cinematic-mode",
        unlocked: false,
        prerequisites: ["cinematic continuity approval", "multi-shot containment review"],
        still_forbidden_operations: forbidden,
      },
      {
        continuity_id: "governed-episodic-sequencing",
        unlocked: false,
        prerequisites: ["episodic sequencing governance approval", "continuity drift audit"],
        still_forbidden_operations: forbidden,
      },
      {
        continuity_id: "governed-feature-length-orchestration",
        unlocked: false,
        prerequisites: ["feature-length orchestration governance approval", "long-window rollback proof"],
        still_forbidden_operations: forbidden,
      },
    ],
  };
...
function buildTemporalTransitionValidation(input: {
  ...
  const checks: CinematicTemporalTransitionValidationCheck[] = [
    ...
    },
    {
      ...
      passed: (containment?.maximum_frame_count ?? 0) >= 3 && (containment?.maximum_frame_count ?? 0) <= 5 && (containment?.maximum_duration_seconds ?? 0) <= 2,
      detail: "The first motion preview clip must stay ultra-short: 3-5 frames and at most 2 seconds.",
      blockers: (containment?.maximum_frame_count ?? 0) >= 3 && (containment?.maximum_frame_count ?? 0) <= 5 && (containment?.maximum_duration_seconds ?? 0) <= 2 ? [] : ["Motion preview clip exceeds the bounded length policy."],
    },
    {
...
function applyGatedInferencePrecursorReadiness(input: {
  ...
  continuitySequenceContainment: CinematicContinuitySequenceContainmentRegistryEntry[];
  governedMicroSequenceSandbox: CinematicGovernedMicroSequenceSandbox;
  continuityPreviewSequencing: CinematicContinuityPreviewSequencingPath;
  ...
  const updatedMilestones = input.readiness.milestone_progress.map((entry) => {
    ...
    switch (entry.milestone) {
      ...
      case "self-sustaining-generation-readiness":
        return {
          ...entry,
          percentage: clampPercentage(entry.percentage + 6),
          blockers: uniqueNormalizedStrings([...blockers, "Self-sustaining generation remains forbidden pending a reviewed cinematic-continuity bridge."]),
        };
      default:
        return entry;
    }
...
export async function validateCinematicControlledLocalInferenceBootstrap(input?: {
  ...
  const continuitySequenceContainment = buildContinuitySequenceContainmentRegistry({
    readiness,
    authorizationRegistry: realOutputAuthorizationRegistry,
  });
  const frameToFrameContinuityValidation = buildFrameToFrameContinuityValidation({
  ...
  const governedMicroSequenceSandbox = await executeGovernedMicroSequenceSandbox({
    root: initialization.repoRoot,
    sequenceContainment: continuitySequenceContainment,
  ...
  const continuityPreviewSequencing = buildContinuityPreviewSequencingPath({
    sequenceContainment: continuitySequenceContainment,
    microSequenceSandbox: governedMicroSequenceSandbox,
    continuityValidation: frameToFrameContinuityValidation,
  });
  const sequenceRollbackRecovery = buildSequenceRollbackRecoveryLayer({
    sequenceContainment: continuitySequenceContainment,
    microSequenceSandbox: governedMicroSequenceSandbox,
    continuityPreviewSequencing,
    continuityValidation: frameToFrameContinuityValidation,
  });
  const futureCinematicContinuity = buildFutureCinematicContinuityScaffolding({
    sequenceContainment: continuitySequenceContainment,
    continuityValidation: frameToFrameContinuityValidation,
  });
  ...
  await writeProductionMemoryRecord(initialization.productionMemoryPath, {
    ...
    continuity_sequence_containment_history: [continuitySequenceContainment, ...trackingUpdate.record.continuity_sequence_containment_history].slice(0, 24),
    governed_micro_sequence_sandbox_history: [governedMicroSequenceSandbox, ...trackingUpdate.record.governed_micro_sequence_sandbox_history].slice(0, 24),
    continuity_preview_sequencing_history: [continuityPreviewSequencing, ...trackingUpdate.record.continuity_preview_sequencing_history].slice(0, 24),
  ...
  return {
    ...
    continuity_sequence_containment: continuitySequenceContainment,
    governed_micro_sequence_sandbox: governedMicroSequenceSandbox,
    continuity_preview_sequencing: continuityPreviewSequencing,
...
export async function simulateCinematicControlledLocalInferenceBootstrap(input?: {
  ...
  const simulation: CinematicSandboxSimulationRecord = {
    ...
    continuity_sequence_containment: validation.continuity_sequence_containment,
    governed_micro_sequence_sandbox: validation.governed_micro_sequence_sandbox,
    continuity_preview_sequencing: validation.continuity_preview_sequencing,
