        ...
        *,
        ...
        return DataRecord(
            ...
            normalized_input={
                ...
                "progress_state": step.progress_state,
                "transition_reason": step.transition_reason,
            ...
            context_payload={
                ...
                "resume_count": chain.resume_count,
                "progress_state": chain.progress_state,
                "last_decision_summary": chain.last_decision_summary,
                "chain_metadata": self._clean_mapping(chain.metadata),
            },
            result_payload=self._clean_mapping(
                {
                    **step.to_payload(),
                    "previous_stage": step.previous_stage,
