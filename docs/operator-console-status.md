# Operator console status (archived)

This file is the older Windows OpenClaw / AI-E v1 operator-console writeup. The public product spine is documented in the root [README.md](../README.md). The content below is preserved for local desktop context; it is not the public demo contract.
